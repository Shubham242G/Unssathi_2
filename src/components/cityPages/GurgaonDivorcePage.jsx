  ...
  return (
    <div className="bg-[#f5f1ed] text-[#232122]">
      ...
      <section className="bg-[#232122] text-white py-16 text-center px-6">
        <h2 className="text-3xl font-serif mb-4">Need Legal Help in Gurgaon?</h2>
        <p className="mb-6 text-gray-300">Speak with our expert lawyers and get clarity on your case today.</p>
