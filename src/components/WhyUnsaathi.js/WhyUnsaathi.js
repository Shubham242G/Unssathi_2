    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div className="bg-[#f5efe9] p-8 rounded-2xl shadow-sm text-center">
        <div className="flex justify-center mb-6">
          ...
          <div className="w-40 h-32 bg-gray-200 rounded-md flex items-center justify-center">
             {/* <img src="/path/to/time-image.png" alt="Time" className="object-contain"/> */}
          </div>
        </div>
      ...
      <div className="bg-[#f5efe9] p-8 rounded-2xl shadow-sm text-center">
        <div className="flex justify-center mb-6">
          ...
          <div className="w-40 h-32 rounded-md flex items-center justify-center">
            <img src="/assets/money_puzzels.png" alt="Money" className="object-contain"/>
          </div>
        </div>
      ...
      <div className="bg-[#f5efe9] p-8 rounded-2xl shadow-sm text-center">
        <div className="flex justify-center mb-6">
          ...
          {/* Replace this div with your <img /> or <Lottie /> component */}
          <div className="w-40 h-32 rounded-md flex items-center justify-center">
            <img src="/assets/flower.png" alt="Peace of Mind" className="object-contain"/>
          </div>
        </div>
