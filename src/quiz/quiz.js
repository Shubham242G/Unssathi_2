import React, { useState, useCallback } from 'react'; // <-- I have removed 'useEffect' from this line
...
const DivorceInsightQuiz = () => {
  ...
  // It's a good practice to memoize this function as it's used in getConclusion
  ...
  }, [score]); // This function only needs to be recreated when 'score' changes
  ...
  return (
    <div className="w-full mx-auto my-20 bg-[#f5f1ed] font-serif text-[#3d3d3d]">
      {!isStarted ? (
        ...
        // Check if conclusion exists before trying to access its properties
